...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 CORSAIR - Сайт завантажується...');
...
console.log('✅ CORSAIR JavaScript завантажено успішно!');
